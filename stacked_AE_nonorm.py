...
class cnn_encoder(Model):
  def __init__(self,filter_num, ch,limit):
    ...
    self.c1 = Conv1D(filter_num, 5, strides=2,padding='valid', kernel_initializer=initializer)
    
    self.d1 = Dense(filter_num, kernel_initializer=initializer)
    self.d2 = Dense(self.output_ch, kernel_initializer=initializer)
...
class cnn_decoder(Model):
  def __init__(self,filter_num,ch,limit):
    ...
    self.c1 = Conv1D(filter_num, 3, strides=1,padding='valid', kernel_initializer=initializer)
    self.c2 = Conv1D(filter_num, 3, strides=1,padding='valid', kernel_initializer=initializer)

    self.d1 = Dense(ch, kernel_initializer=initializer)
...
class ae_hie(Model):
    def __init__(self):
        ...
        self.cen_L1 = cnn_encoder(32,7,0.41016)
        self.cen_L1._name = 'cen_l1'
        
        self.cen_L2 = cnn_encoder(64,13,0.29688)
        self.cen_L2._name = 'cen_l2'
        
        self.cen_L3 = cnn_encoder(128,25,0.21875)#0.2148
        self.cen_L3._name = 'cen_l3'
        
        self.cen_L4 = cnn_encoder(256,49,0.15625)
        self.cen_L4._name = 'cen_l4'
        
        self.cen_L5 = cnn_encoder(512,97,0.10352)
        self.cen_L5._name = 'cen_l5'
        
        self.cen_L6 = cnn_encoder(1024,193,0.07812)
        self.cen_L6._name = 'cen_l6'
        
        self.cen_L7 = cnn_encoder(2048,385,0.05371)
        self.cen_L7._name = 'cen_l7'
        
        
        self.cde_L1 = cnn_decoder(16,4,0.4375)
        self.cde_L1._name = 'cde_l1'
        
        self.cde_L2 = cnn_decoder(32,7,0.30762)
        self.cde_L2._name = 'cde_l2'
        
        self.cde_L3 = cnn_decoder(64,13,0.21875)
        self.cde_L3._name = 'cde_l3'
        
        self.cde_L4 = cnn_decoder(128,25,0.14843)
        self.cde_L4._name = 'cde_l4'
        
        self.cde_L5 = cnn_decoder(256,49,0.1073)
        self.cde_L5._name = 'cde_l5'
        
        self.cde_L6 = cnn_decoder(512,97,0.07617)
        self.cde_L6._name = 'cde_l6'
        
        self.cde_L7 = cnn_decoder(1024,193,0.05469)
