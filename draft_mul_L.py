...
Each level of the latent vectors are the same, this is implemented by the loss
'''
...
class cnn_encoder_hie(Model):
    ...
    def call(self, x_input):
        ...
        return latent_L1,latent_L2,latent_L3,latent_L4,latent_L5,latent_L6,latent_L7
...
class cnn_decoder_hie(Model):
    ...
    def call(self, x_input):
        ...
        return latent_L1_rec,latent_L2_rec,latent_L3_rec,latent_L4_rec,latent_L5_rec,latent_L6_rec,latent_L7_rec
...
l2,l3,l4,l5,l6,l7,lat = cen_hie(inputs)
l1_rec,l2_rec,l3_rec,l4_rec,l5_rec,l6_rec,l7_rec = cde_hie(lat)
auto_hie = tf.keras.Model(inputs=inputs, outputs=l1_rec)
...
def dis_loss(x,la=0.01):
    ...
    l2,l3,l4,l5,l6,l7,z = cen_hie(x)
    l1_rec,l2_rec,l3_rec,l4_rec,l5_rec,l6_rec,l7_rec = cde_hie(z)
    
    loss_L1 = dis_loss_pair(x,l1_rec)
    loss_L2 = dis_loss_pair(l2,l2_rec)
    loss_L3 = dis_loss_pair(l3,l3_rec)
    loss_L4 = dis_loss_pair(l4,l4_rec)
    loss_L5 = dis_loss_pair(l5,l5_rec)
    loss_L6 = dis_loss_pair(l6,l6_rec)
    loss_L7 = dis_loss_pair(l7,l7_rec)
    
    loss_all = (loss_L1+loss_L2+loss_L3+loss_L4+loss_L5+loss_L6+loss_L7)
